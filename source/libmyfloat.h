...
MY_DLL_API MY_EXTERN float asinf(float a);
MY_DLL_API MY_EXTERN float acosf(float a);
MY_DLL_API MY_EXTERN float atanf(float a);
...
MY_DLL_API MY_EXTERN float asinhf(float a);
MY_DLL_API MY_EXTERN float acoshf(float a);
MY_DLL_API MY_EXTERN float atanhf(float a);
...
MY_DLL_API MY_EXTERN double asin(double a);
MY_DLL_API MY_EXTERN double acos(double a);
MY_DLL_API MY_EXTERN double atan(double a);
...
MY_DLL_API MY_EXTERN double asinh(double a);
MY_DLL_API MY_EXTERN double acosh(double a);
MY_DLL_API MY_EXTERN double atanh(double a);
